...
export default function ActiveCampaignDashboard() {
    ...
    return (
        <div className="flex flex-col items-center justify-center [@media(min-height:950px)]:h-rsvh overflow-y-auto overflow-x-clip">
            <div className="[@media(min-height:950px)]:hidden w-screen h-14"></div>
